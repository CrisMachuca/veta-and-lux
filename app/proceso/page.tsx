    ...
    <main className="min-h-screen bg-stone-50 text-stone-800 antialiased">
      ...
      <header className="max-w-4xl mx-auto px-6 pt-24 pb-20 text-center">
        ...
        <p className="max-w-xl mx-auto mt-6 text-stone-500 font-light text-sm md:text-base leading-relaxed">
          Cada lámpara de Veta & Lux no se fabrica; se escucha y se libera. Seguimos un proceso honesto, pausado y profundamente respeotuoso con los ciclos del tiempo.
        </p>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-32 space-y-24 md:space-y-36">
        ...
        {/* 🎥 PASO 1 CON VÍDEO INTEGRADO */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
          <div className="md:col-span-7 bg-stone-100 aspect-[4/3] rounded-sm relative overflow-hidden shadow-inner flex items-center justify-center">
            <video
              autoPlay
              loop
              muted
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-stone-600 font-light text-sm leading-relaxed">
              Buscamos maderas que ya han vivido, prestando especial atención a sus nudos y cicatrices. El vídeo adjunto evoca el entorno natural donde nace cada historia.
            </p>
          </div>
        </div>

        {/* 🛠️ PASO 2 CORREGIDO: El Letargo (Curado) */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center md:flex-row-reverse">
          <div className="md:col-span-7 md:order-2 bg-stone-200 aspect-[4/3] rounded-sm relative overflow-hidden shadow-inner flex items-center justify-center text-stone-400 text-xs tracking-widest uppercase font-mono">
            <img
              src="/curado.png"
              alt="Madera recuperada en proceso de curado"
          ...
          <div className="md:col-span-5 md:order-1 space-y-4">
            ...
            <p className="text-stone-600 font-light text-sm leading-relaxed">
              La madera viva retiene humedad y tensiones. Al llegar al taller, cada pieza inicia un periodo de reposo absoluto que puede durar meses.
            </p>
            <p className="text-stone-600 font-light text-sm leading-relaxed">
        ...
        {/* Paso 3: El Saneado Humilde */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
          <div className="md:col-span-7 bg-stone-200 aspect-[4/3] rounded-sm relative overflow-hidden shadow-inner flex items-center justify-center text-stone-400 text-xs tracking-widest uppercase font-mono">
            <img
              src="/saneado.jpeg"
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-stone-600 font-light text-sm leading-relaxed">
              Tratamos la madera contra xilófagos mediante técnicas no invasivas y aplicamos aceites y ceras orgánicas texturizadas a mano, nutriendo el poro sin ocultar el tacto puro de la madera.
            </p>
          </div>
        </div>

        {/* Paso 4: La Arquitectura de la Luz */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center md:flex-row-reverse">
          <div className="md:col-span-7 md:order-2 bg-stone-200 aspect-[4/3] rounded-sm relative overflow-hidden shadow-inner flex items-center justify-center text-stone-400 text-xs tracking-widest uppercase font-mono">
            <img
              src="/tronco2.jpeg"
              alt="Componentes eléctricos y ensamblaje de la lámpara"
              className="w-full h-full object-cover"
            />
          </div>
          <div className="md:col-span-5 md:order-1 space-y-4">
            ...
            <p className="text-stone-600 font-light text-sm leading-relaxed">
              Una lámpara premium requiere una electrónica impecable. Diseñamos las canalizaciones internas ocultas de forma milimétrica para no alterar la estética de la madera.
            </p>
            <p className="text-stone-600 font-light text-sm leading-relaxed">
        ...
        {/* Cierre / Manifiesto */}
        <div className="bg-stone-900 text-stone-100 p-8 md:p-16 rounded-sm text-center space-y-6 max-w-3xl mx-auto">
